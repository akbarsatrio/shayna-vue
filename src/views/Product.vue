			...
			<div class="row">
				<div class="col-lg-12">
					<div class="breadcrumb-text product-more">
						<router-link to="/"><i class="fa fa-home mr-2"></i>Home</router-link>
						<span>Detail</span>
					</div>
				</div>
			</div>
					...
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="product-thumbs">
								<carousel class="product-thumbs-track ps-slider" :nav="0" :items="3" :dots="0">
									<div class="pt mr-2" @click="changeImage(thumbs[0])" :class="thumbs[0] == defaultImage ? 'active' : ''">
										<img src="img/mickey1.jpg" alt="" />
									</div>

									<div class="pt mr-2" @click="changeImage(thumbs[1])" :class="thumbs[1] == defaultImage ? 'active' : ''">
										<img src="img/mickey2.jpg" alt="" />
									</div>

									<div class="pt mr-2" @click="changeImage(thumbs[2])" :class="thumbs[2] == defaultImage ? 'active' : ''">
										<img src="img/mickey3.jpg" alt="" />
									</div>

									<div class="pt mr-2" @click="changeImage(thumbs[3])" :class="thumbs[3] == defaultImage ? 'active' : ''">
